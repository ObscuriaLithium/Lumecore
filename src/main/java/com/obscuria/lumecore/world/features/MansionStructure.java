package com.obscuria.lumecore.world.features;

import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import com.obscuria.lumecore.registry.LumecoreStructures;
...
public class MansionStructure extends Structure {
    ...
    public static final Codec<MansionStructure> CODEC = RecordCodecBuilder.<MansionStructure>mapCodec(instance ->
            instance.group(MansionStructure.settingsCodec(instance),
            ...
            ).apply(instance, MansionStructure::new)).codec();
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!MansionStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return LumecoreStructures.MANSION.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}