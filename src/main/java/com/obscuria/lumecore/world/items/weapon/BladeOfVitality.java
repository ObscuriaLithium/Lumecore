...
public class BladeOfVitality extends SwordItem {
    public BladeOfVitality() {
        super(LumecoreTiers.COMMON, 7, -2.2F, new Properties().tab(LumecoreMod.TAB).rarity(Rarity.UNCOMMON));
    }

    @Ability public final ObscureAbility ABILITY = new ObscureAbility(this, "blade_of_vitality", ObscureAbility.Cost.NONE, 0, 20);
